...
tf.app.flags.DEFINE_string("en_train", './data/train.ids10000.en', "modern train ids path")
tf.app.flags.DEFINE_string("fr_train", './data/train.ids10000.ja', "original train ids path")

tf.app.flags.DEFINE_string("en_dev", './data/dev.ids10000.en', "modern dev ids path")
tf.app.flags.DEFINE_string("fr_dev", './data/dev.ids10000.ja', "original dev ids path")

tf.app.flags.DEFINE_string("en_test", './data/test.ids10000.en', "modern dev ids path")
tf.app.flags.DEFINE_string("fr_test", './data/test.ids10000.ja', "original dev ids path")

tf.app.flags.DEFINE_string("en_vocab", './data/vocab10000.en', "modern vocab path")
tf.app.flags.DEFINE_string("fr_vocab", './data/vocab10000.ja', "original vocab path")
...
def decode():
  with tf.Session() as sess:
    ...
    while sentence:
      ...
      token_ids = data_utils.sentence_to_token_ids(sentence, en_vocab, tokenizer=data_utils.basic_tokenizer)
